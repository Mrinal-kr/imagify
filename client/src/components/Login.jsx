  ...
  return (
    ...
    bg-black/30 flex justify-center items-center'>
        ...
        className='relative bg-white p-10 rounded-xl text-slate-500'>
            ...
            <p className='text-sm pt-2 text-center'>Welcome back! Please sign in to continue</p>
            ...
            <div className='border px-6 py-2 flex items-center gap-2 rounded-full mt-4'>
                <img src={assets.email_icon} className='h-4' alt="" />
                <input onChange={e=>setEmail(e.target.value)} value={email}
                type="email" className='outline-none text-sm' placeholder='email' required/>
            </div>
            <div className='border px-6 py-2 flex items-center gap-2 rounded-full mt-4'>
                <img src={assets.lock_icon} className='h-4' alt="" />
            ...
            <button className='bg-blue-600 rounded-full text-white py-2 w-full'>{state=='Login'? 'login':'Create account'}</button>
